...
func CalculatePPPMTU(wanMTU int, outerIsIPv6, salamander bool, dataStreams int) int {
	...
	if dataStreams > 0 {
		...
		framingOverhead = quicShortHeader + quicAEADTag + datagramFrameOverhead + PPPHeaderLen
	}
	...
	// compute is 1452 - 21 - 32 = 1399. It stays because that cap is quic-go's
